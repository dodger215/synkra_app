<x-layouts.auth title="Verify Account">
    <x-ui.auth.card>
        <x-slot:header>
            ...
            <h2 class="flowexa-auth-card-title">Verify Your Account</h2>
            <p class="flowexa-auth-card-subtitle" style="font-size: 0.95rem; line-height: 1.5; padding: 0 1rem;">
        ...
        <form method="POST" action="{{ route('mfa.verify.submit') }}">
            ...
            <div class="flowexa-form-group" style="width: 100%; margin-bottom: 1.5rem;">
            ...
            <div class="flowexa-form-actions" style="margin-top: 2rem;">
                <x-ui.button type="submit" icon="fa-solid fa-check-circle" style="width: 100%;">Verify Account</x-ui.button>
            </div>
        </form>

        <div class="flowexa-auth-links" style="margin-top: 1.5rem; text-align: center;">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; align-items: center; flex-wrap: wrap;">
                <form method="POST" action="{{ route('mfa.resend') }}">
                    @csrf
                    <button type="submit" class="flowexa-auth-link" style="background: none; border: none; cursor: pointer; padding: 0; font-family: inherit;">Resend Code</button>
                </form>
                ...
                <form method="POST" action="{{ route('mfa.resend') }}">
                    ...
                    <button type="submit" class="flowexa-auth-link" style="background: none; border: none; cursor: pointer; padding: 0; font-family: inherit;">Send via Email instead</button>
                </form>
                ...
                <form method="POST" action="{{ route('mfa.resend') }}">
                    ...
                    <button type="submit" class="flowexa-auth-link" style="background: none; border: none; cursor: pointer; padding: 0; font-family: inherit;">Send via SMS instead</button>
                </form>
                @endif
            </div>
        </div>

    ...
    <x-ui.grid>
        <div class="synkra-dashboard-container" style="padding:2rem;max-width:1200px;margin:0 auto;">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:2rem;">
                ...
                <button type="button" onclick="openSynkraModal('addLocationModal')"
                    ...
                    @php
                        ...
                        $rows = $locations->map(function ($location) {
                            ...
                            $actions = new \Illuminate\Support\HtmlString(
                                ...
                                . '<button type="button" class="synkra-table-action-btn" title="Edit"'
        ...
        <x-ui.modal id="addLocationModal" triggerId="addLocationModal-trigger-btn" title="Add Stock Location">
            ...
            <x-slot:footer>
                <button type="button" style="background:transparent;border:1px solid var(--border);color:var(--text-secondary);cursor:pointer;padding:.5rem 1rem;border-radius:8px;" onclick="closeSynkraModal('addLocationModal')">Cancel</button>
        ...
        <x-ui.modal id="editLocationModal" triggerId="editLocationModal-trigger-btn" title="Edit Stock Location">
            ...
            <x-slot:footer>
                <button type="button" style="background:transparent;border:1px solid var(--border);color:var(--text-secondary);cursor:pointer;padding:.5rem 1rem;border-radius:8px;" onclick="closeSynkraModal('editLocationModal')">Cancel</button>
        ...
        function openEditLocationModal(btn) {
            ...
            openSynkraModal('editLocationModal');
        }
        </script>
    </x-ui.grid>
</x-layouts.app>
